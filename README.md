...
5. Relay Board - 5V
6. Logic Level Converter Bi-Directional
...
8. I used D7 as my input to check the second relay is on or not.
...
10. I used V0?value=1 to toggle the second relay on and V0?value=0 to toggle it off.

This projects works on the principal of a two way switch and i use voltage sensing to toggle the second relay on and off
