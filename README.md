...
<h2>Step One</h2>
1. Upload the sketch given to your NodeMCU using its specifictaions. <br>
...
8. For me using blynk-cloud.com would give me error 400 on IFTTT i.e. invalid token i used ping to get the ip address of blynk-cloud.com and then use that ip address (Note: IP address can change hence using the domain name is recommended but for me it would'nt work so i had to use that). <br>
